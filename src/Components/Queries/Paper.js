        ...
        <section className="pt-4">
          {paperList.map((paper, index) => (
            <Link to={paper.paper} key={index} onClick={() => setPaper(paper)}>
              <article className="mb-4 flex items-center whitespace-break-spaces rounded-md border-2 border-slate-900 bg-blue-200 p-2 hover:bg-blue-950 hover:text-slate-100 dark:border-slate-200 dark:bg-slate-950/5 dark:hover:border-blue-500 dark:hover:bg-slate-950/80 lg:p-4 ">
